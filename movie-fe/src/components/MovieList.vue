        ...
        <div class="col col-12 col-md-10 d-none d-xl-block d-lg-block d-md-block">
          <table class="table table-hover" style="overflow-y: auto"
            ...
            <tr>
              ...
              <th scope="col">Director</th> <!-- Added Director column -->
            ...
            <tr v-for="movie in movies" v-bind:key="movie">
              ...
              <td>{{ movie.year }}</td>
              <td>{{ movie.rating }}</td>
              <td>{{ movie.director }}</td> <!-- Added Director field display -->
          ...
          <!-- Only allow adding a movie when authenticated user -->
      ...
      data() {
        return {
          ...
          headers: [
            ...
            {text: 'Director', sortable: false, align: 'left'},  // Added Director to headers
